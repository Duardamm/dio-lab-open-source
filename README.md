...
> [!NOTE]   
> Por exemplo, a URL https://github.com/Duardamm/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`Duardamm`" para a contribuição no repositório `dio-lab-open-source`.
